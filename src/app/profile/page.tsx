      ...
      <div className="md:ml-64 min-h-screen p-4 md:p-8 pb-32 md:pb-8">
        ...
        <div className="relative z-10 mb-8">
          <div className="glass-card rounded-3xl p-8 md:p-12 bg-gradient-to-br from-purple-500/10 to-blue-500/10 border-2 border-white/10">
            ...
            {/* Account Status and Change Password - Inline */}
            <div className="mt-8 flex flex-col md:flex-row gap-4 items-start">
              {/* Account Status - Inside Profile Header */}
              <div className="w-fit p-6 rounded-2xl bg-gradient-to-br from-purple-500/20 to-blue-500/20 border border-white/10">
              ...
              <div className="w-fit p-6 rounded-2xl bg-gradient-to-br from-white/10 to-red-900/10 border border-white/10">
